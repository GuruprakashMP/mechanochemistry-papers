...
def _categories_page(papers: List[Paper], ctx: dict) -> str:
    ...
    content = f"""
<h1>Categories</h1>
<p>Every paper belongs to several categories — a mechanochemistry technique or
application and the methods it uses. Click one to browse.</p>
...
mechanochemistry research papers — ball milling and grinding, liquid-assisted
grinding, twin-screw extrusion, mechanocatalysis and mechanoredox, cocrystals
and pharmaceutical solids, MOF and framework mechanosynthesis, polymer
mechanochemistry and mechanophores, piezo- and tribocatalysis, mechanical
alloying and in-situ reaction monitoring — covering experimental,
computational and data-driven studies alike.</p>
<h2>How it works</h2>
<p>Every day an automated pipeline queries open scholarly metadata APIs,
removes duplicates, classifies each paper with a mechanochemistry relevance
